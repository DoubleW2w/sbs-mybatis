...
import com.doublew2w.sbs.mybatis.reflection.invoker.SetFieldInvoker;
import com.doublew2w.sbs.mybatis.reflection.property.PropertyNamer;
 ...
 * 反射器解耦对象
 *
 * <p>负责缓存类的定义信息，并且提供getter和setter方法之间的映射
 *
 * @author: DoubleW2w
 * @date: 2024/9/5 23:40
 * @project: sbs-mybatis
...
public class Reflector {
  ...
  /**
   * 遍历所有具有多个setter方法的属性名。
   *
   * <p>如果只有一个setter方法，则直接添加。
   *
   * <p>如果有多个setter方法：
   *
   * <ol>
   *   <li>获取预期类型
   *   <li>若预期类型为空，抛出异常
   *   <li>否则，遍历setter方法列表，寻找参数类型与预期类型匹配的方法，并添加。
   *   <li>若未找到匹配方法，抛出异常。
   * </ol>
   *
   * @param conflictingSetters setter方法冲突列表
   */
